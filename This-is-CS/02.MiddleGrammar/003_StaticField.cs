...
namespace _002.MiddleGrammar
{
    ...
    // 기억해야 할 것은 정적 메소드가 클래스의 인스턴스를 생성하지 않아도 호출이 가능한 메소드라는 점입니다. 정적 메소드는 다음과 같이 선언하고 사용합니다.
    // 비 정적 매소드는 클래스에 소속되는 정적 메소드와 달리 인스턴스에 소속된다고 해서 인스턴스 메소드라고 합니다. 인스턴스 메소드는 이름처럼 클래스의 인스턴스를 
    // 생성해야만 호출할 수 있는 메소드입니다. 다음 코드가 인스턴스 메소드의 예입니다.

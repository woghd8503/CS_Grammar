...
namespace Test1
{
    ...
    // Q6. 다향성은 무엇이며, 오버라이딩과 무슨 관계가 있는지 설명하세요.

    // A6. 다형성 Polymorphism은 개체가 여러 형태를 가질 수 있음 이라고 정의하고 있다.
    //     다형성은 같은 지시를 통해 서로 다르게 동작하는 것을 뜻하며, 오버라이딩은 다형성을 구현할 수 있는 방법 중 하나다.
